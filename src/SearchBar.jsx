...
function SearchBar() {
  ...
  const [selectedRegions, setSelectedRegions] = useState({
    "Region I": false, "Region II": false, "Region III": false,
    "Region IV-A": false, "Region IV-B": false, "Region V": false,
    "Region VI": false, "Region VII": false, "Region VIII": false,
    "Region IX": false, "Region X": false, "Region XI": false,
    "Region XIII": false, "NCR": false, "CAR": false,
    "BARMM": false, "NIR": false,
  });
  ...
  return (
    <div className="searchbarcontainer">
      ...
      <div className="searchbar">
        ...
        {isSpeechSupported ? (
            <button onClick={startListening} aria-label="Voice search" className="voice-btn">
                Voice Search
            </button>
        ) : (
            <button disabled title="Voice input is not supported in this browser" className="voice-btn">
                Voice Search
            </button>
        )}
        ...
        <div className="filter-wrapper" onClick={toggleDropdown}>
          ...
          {isDropdownOpen && (
            <div id="filterDropdown" className="dropdown-content" onClick={stopDropdownClose}>
      ...
      {!isSpeechSupported && (
        <p className="speech-warning">
          <i style={{color: "gray"}}>Your browser does not support voice input. Try another browser for the best experience.</i>
        </p>
      )}
    </div>
  );
